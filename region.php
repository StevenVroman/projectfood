...
$regions = CallAPI("GET", $DB2."/tblusers");


foreach($regions as $region){
    if($region["Username"]==$account){
        /*fav regio*/
        $favori = $region["FavFood"];
        $regionname = $areas['meals'][$favori]['strArea'];
    }
}
$arealist = CallAPI("GET", $DB."/filter.php?a=".$regionname);
?>
...
<body id="region" class="container-fluid">
    ...
    <div id="navigatie" class="col-12"> 
        <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="region.php">Your Region</a>
                </li>
            </ul>
            </div>
        </nav>  
